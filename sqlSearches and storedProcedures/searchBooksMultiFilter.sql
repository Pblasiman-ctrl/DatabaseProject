...
BEGIN
    SELECT b.title as "Title", a.author_name as "Author", c.category_name as "Category", f.format_name as "Format", b.isbn_13 as "ISBN", b.description as "Description", b.bestseller_rank as "Bestseller Ranking", b.average_rating as "Average Rating"
    FROM book b
